...
class RVC:
    ...
    def infer(
        ...
        # feats = feats.cpu()
        # p_len_tensor = p_len_tensor.cpu()
        # cache_pitch = cache_pitch.cpu()
        # cache_pitchf = cache_pitchf.cpu()
        ...
        # infered_audio = infered_audio.squeeze(1).float().to(self.device)

        # print(
        #     "OUTPUT:",
        #     "min=", infered_audio.min().item(),
        #     "max=", infered_audio.max().item(),
        #     "mean=", infered_audio.mean().item(),
        #     "std=", infered_audio.std().item(),
        # )
